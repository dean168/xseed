...
public class HibernateTemplateImpl extends HibernateTemplate implements IHibernateOperations {
    ...
    @Transactional
    public <T> T xtx(TransactionalExtractor1<T> extractor) {
        try {
    ...
    @Transactional
    public <T> T xtx(TransactionalExtractor2<T> extractor) {
        try {
    ...
    @Transactional
    public void xtx(TransactionalHandler1 handler) {
        try {
            handler.process();
        } catch (Exception e) {
            throw new DataAccessException(null, e) {
    ...
    @Transactional
    public void xtx(TransactionalHandler2 handler) {
        try {
